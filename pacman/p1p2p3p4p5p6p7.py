...
def scoreboard():
    ...
    def display_scoreboard():
        ...
        # Header
        header_text = header_font.render("HIGH SCORE", True, header_color)
        screen.blit(header_text, (SCREEN_WIDTH // 2 - header_text.get_width() // 2, 50))

        # Column headers
        col_width = SCREEN_WIDTH // 3
        name_header = entry_font.render("NAME", True, header_color)
        level_header = entry_font.render("LEVEL", True, header_color)
        score_header = entry_font.render("SCORE", True, header_color)
