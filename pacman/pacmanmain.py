...
def start():
    ...
    def level_selection():
        ...
        back_rect = pygame.Rect(400, 600, 500, 50)
...
def Pacman(level_color, level_speed):
   ...
   #loading and trasnforming the ghost pictures
    ...
    pacman_chomp = pygame.mixer.Sound('Pacman_Eating.mp3')
    man_scream = pygame.mixer.Sound('man-scream-121085.mp3')
    ...
    def draw_misc():
        ...
        if game_over:
            gameover_img= pygame.transform.scale(pygame.image.load("gover.jpg"), (WIDTH, HEIGHT))
